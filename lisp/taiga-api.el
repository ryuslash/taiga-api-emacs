...
(defclass taiga-api-issue-status-detail (taiga-api-object)
  ((color :initarg :color)
   (id :initarg :id)
   (is-closed :initarg :is-closed)
   (name :initarg :name)
...
(cl-defmethod shared-initialize ((obj taiga-api-issue-status-detail) slots)
  (cl-call-next-method)
  (taiga-api--set-bools obj (plist-get slots :alist) '(is-closed)))

(defun taiga-api-issue-status-detail-from-alist (alist)
  "Turn ALIST into a `taiga-api-attribute'."
...
(defclass taiga-api-point-detail (taiga-api-object)
  ((color :initarg :color)
   (id :initarg :id)
   (name :initarg :name)
   (order :initarg :order)
...
(defun taiga-api-point-detail-from-alist (alist)
...
(defclass taiga-api-task-status-detail (taiga-api-object)
  ((color :initarg :color)
   (id :initarg :id)
   (is-closed :initarg :is-closed)
   (name :initarg :name)
...
(cl-defmethod shared-initialize ((obj taiga-api-task-status-detail) slots)
  (cl-call-next-method)
  (taiga-api--set-bools obj (plist-get slots :alist) '(is-closed)))

(defun taiga-api-task-status-detail-from-alist (alist)
