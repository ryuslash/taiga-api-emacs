...
(ert-deftest taiga-api-wiki-page-from-alist ()
  ...
  (let ((page (taiga-api-wiki-page-from-alist
...
(ert-deftest taiga-api-user-story-from-alist ()
  ...
  (let ((story (taiga-api-user-story-from-alist
                '((assigned_to . 19)
                  ...
                  (tags . ["service catalog" "customer"])
                  (team_requirement . nil)
                  (total_points . 1.0)
                  (version . 8)
                  (watchers . nil)))))
...
(ert-deftest taiga-api-neighbors-from-alist ()
  ...
  (let ((neighbors (taiga-api-neighbors-from-alist
                    '((next (id . 16)
                            (ref . 126)
                            (subject . "Support for bulk actions"))
                      (previous)))))
...
(ert-deftest taiga-api-neighbor-from-alist ()
  ...
  (let ((neighbor (taiga-api-neighbor-from-alist
                   '((id . 16)
                     (ref . 126)
                     (subject . "Support for bulk actions")))))
...
(ert-deftest taiga-api-task-from-alist ()
  ...
  (let ((task (taiga-api-task-from-alist
               '((assigned_to . 19)
                 (blocked_note . "")
                 (blocked_note_html . "")
                 (comment . "")
...
(ert-deftest taiga-api-search-result-from-alist ()
  ...
  (let ((result (taiga-api-search-result-from-alist
                 '((wikipages . [((html . "<p>Lorem ipsum dolor.</p>")
                                  (editions . 1)
                                  (id . 1)
                                  (version . 1)
                                  (project . 1)
